...
import com.example.noone.bluetoothdemo2.gatt.TimeProfile;
...
public class CtsServerActivity extends Activity {
    private static final String TAG = "GATT Current Time Service";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cts_server);
